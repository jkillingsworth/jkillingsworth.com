...
let execute name func range =
    ...
    Chart.renderHeatmap (path name + "-heatmap-0.svg") heatmap range 0 Array.empty
    ...
    Chart.renderHeatmap (path name + "-heatmap-1.svg") heatmap range 1 slice1
    Chart.renderProfile (path name + "-profile-1.svg") samples range 1 slice1

    Chart.renderHeatmap (path name + "-heatmap-2.svg") heatmap range 2 slice2
    Chart.renderProfile (path name + "-profile-2.svg") samples range 2 slice2
