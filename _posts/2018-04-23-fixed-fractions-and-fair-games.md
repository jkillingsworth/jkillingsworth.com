...
{% latex fig-09 %}
    ...
    \lim_{n \to \infty}
    \2
    \brace*[]{ V_0 + \frac{1}{n} \sum_{i = 1}^{n} R(X_i) }
    \end{displaymath}
    \end{document}
{% endlatex %}
...
{% latex fig-11 %}
    ...
    \begin{displaymath}
    \begin{aligned}
    A & = V_0 + \frac{1}{n} \brace2[]{ W(+bV_0) + L(-bV_0) }
    \\[1em]
...
{% latex fig-20 %}
    ...
    \lim_{n \to \infty}
    \2
    \brace*[]{ V_0 \1 \brace*(){ \prod_{i = 1}^{n} R(X_i) }^\frac{1}{n} }
    \end{displaymath}
    \end{document}
{% endlatex %}
...
{% latex fig-21 %}
    ...
    \begin{displaymath}
    \begin{aligned}
    G & = V_0 \1 \brace2[]{ (1 + b)^W (1 - b)^L }^\frac{1}{n}
    \\[1em]
      & = V_0 \1 \brace2[]{ (1 + b) (1 - b) }^\frac{1}{2}
    \\[1em]
      & = V_0 \sqrt{0.96}
    \end{aligned}
    \end{displaymath}
