...
<figure class="fullwide">
  <img width="720" height="405" alt="Figure 6" src=".{{ page.id }}/fig-06.svg" />
</figure>
...
<figure class="fullwide">
  <img width="720" height="405" alt="Figure 15" src=".{{ page.id }}/fig-15.svg" />
</figure>
...
<figure class="fullwide">
  <img width="720" height="405" alt="Figure 16" src=".{{ page.id }}/fig-16.svg" />
</figure>
