...
{% latex 1 fig-06 %}
    ...
    \mathbf{J}(\mathbf{x})
    =
    \frac{\dderiv \mathbf{\1f\1}(\mathbf{x})}{\dderiv \mathbf{\1x}}
    =
    \begin{matrix}{cccc}
    \dfrac{\pderiv f_1(\mathbf{x})}{\pderiv x_1}
    &
    \dfrac{\pderiv f_1(\mathbf{x})}{\pderiv x_2}
    &
    \cdots
    &
    \dfrac{\pderiv f_1(\mathbf{x})}{\pderiv x_n}
    \\[2em]
    \dfrac{\pderiv f_2(\mathbf{x})}{\pderiv x_1}
    &
    \dfrac{\pderiv f_2(\mathbf{x})}{\pderiv x_2}
    &
    \cdots
    &
    \dfrac{\pderiv f_2(\mathbf{x})}{\pderiv x_n}
    \\[1.5em]
    \vdots
    &
    \vdots
    ...
    \vdots
    \\[1.5em]
    \dfrac{\pderiv f_m(\mathbf{x})}{\pderiv x_1}
    &
    \dfrac{\pderiv f_m(\mathbf{x})}{\pderiv x_2}
    &
    \cdots
    &
    \dfrac{\pderiv f_m(\mathbf{x})}{\pderiv x_n}
    \end{matrix}
    \end{displaymath}
    \end{document}
{% endlatex %}
